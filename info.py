...
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/KuttyMovies_Update/2'))
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/KuttyMovies_Update/2') # How to open tutorial link for verification
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001701455563')) #Log channel id ( make sure bot is admin )
...
URL = "itachi-uchicha.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "itachi-uchicha.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "itachi-uchicha.koyeb.app/".format(FQDN)
else:
    URL = "itachi-uchicha.koyeb.app/".format(FQDN)
